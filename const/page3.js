...
import { Text, View ,TextInput,ImageBackground,StyleSheet,Image,TouchableOpacity, Button} from 'react-native'
...
<View style={styles.View2}>
    ...
    <TouchableOpacity style={[button.button,{marginTop:290}]}>
...
const styles = StyleSheet.create({
   ...
   textview:{width:'80%',marginTop:70},
